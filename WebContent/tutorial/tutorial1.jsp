...
<script type="text/javascript" src="flowplayer-3.2.4.min.js?v=0"></script>
  ...
  <table width="100%" cellspacing="0" cellpadding="0" align="center" class="Main_Client_TableEdition">
	...
	<tr>
	  <td colspan="4">
		...
		<a  
			 href="DemoComoCriarUmaProposta.mp4"  
