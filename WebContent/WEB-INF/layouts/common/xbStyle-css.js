/*
 * xbStyle-css.js
 * $Revision: 1.2 $ $Date: 2008/03/04 13:00:15 $
 *
 */
...
{
//  alert(typeof(oldHeight));
  if (typeof(this.styleObj.height) == 'number')
    this.styleObj.height = height;
  else {
//    setTimeout('sleep',100000);
//    alert(height);
    if (height <= 0) {
//      alert("ggg "+oldHeight);
      this.styleObj.height = oldHeight;
    } else {
      oldHeight = height;  
      this.styleObj.height = height.toString() + 'px';
    }
  }
}
