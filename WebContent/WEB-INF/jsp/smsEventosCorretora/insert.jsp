		...
		<table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
		  ...
		  <tr>
			...
			<td width="32%" class="TextBox_ContentCell">
			  ...
			  <s:select theme="simple" cssClass="dojoValidateValid TextBox_100percent_width" id="smsEventosCorretoraId" name="smsEventosCorretora.smsEventos.id" list="smsEventosList" listKey="id" listValue="nome" headerKey="" headerValue="-- Selecione --" />
			</td>
