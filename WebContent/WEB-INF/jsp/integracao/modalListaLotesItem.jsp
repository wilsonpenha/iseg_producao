...
try {
%>
<div id="divModalListaLoteItem" style="display:none; z-index: 1000; width:760px;" >
	<div id="divListaLoteItem">
		<form id="formLoteItem" name="formLoteItem">
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0" >
					<tr>
					    <td width="50%" class="TitleCell" style="text-align: left">
					    	...
					    	<s:select theme="simple" cssClass="Combo Combo_TwoCells_width" disabled="true" cssStyle="width: 180px" tabindex="0" id="modalRamoId" name="borderoLancamento.ramo.id" list="ramoList" listKey="id" listValue="nome" headerKey="" headerValue="-- Selecione --"/>
					    </td>
