			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				<td width="30%">
				  ...
				  <s:select theme="simple" id="seguradoSeguradoraId" headerKey="" headerValue="-- Selecione --" name="proposta.seguradoIndividual[%{itemCorrente}].seguradora.id" list="seguradoraList" listKey="id" listValue="nome" onchange="setAlterado(true);"/>
				</td>
				<td width="20%">
				  <label for="nroApoliceAnterior">Nro da Apólice Anterior</label><br />
				  <s:textfield theme="simple" id="nroApoliceAnterior" name="proposta.seguradoIndividual[%{itemCorrente}].nroApoliceAnterior" size="15" maxlength="20" onchange="setAlterado(true);"/>
				</td>
				<td width="20%">
				  <label for="codigoIdentificacaoAnterior">C.I. Anterior</label><br />
				  <s:textfield theme="simple" id="codigoIdentificacaoAnterior" name="proposta.seguradoIndividual[%{itemCorrente}].codigoIdentificacaoAnterior" size="20" maxlength="20" onchange="setAlterado(true);"/>
				</td>
				<td width="15%">
				  <label for="categoriaRenovacao">Bônus Percentual</label><br />
				  <s:textfield theme="simple" id="categoriaRenovacao" name="proposta.seguradoIndividual[%{itemCorrente}].categoria" size="15" maxlength="20" onchange="setAlterado(true);"/>
				</td>
				<td width="15%">
				  <label for="classeBonus">Classe Bônus</label><br />
				  <s:textfield theme="simple" id="classeBonus" name="proposta.seguradoIndividual[%{itemCorrente}].classeBonus" size="15" maxlength="20" onchange="setAlterado(true);"/>
				</td>
			  </tr>
