...
%>
	  ...
	  <fieldset>
		  <legend><b>Recebimento da Comissão</b></legend>
				  ...
				  <table id="tableComissionadoItens" class="listItens">
					...
					<tr style="height: 20px;">
					  ...
					  <td>
						...
						<s:textfield theme="simple" name="comissionadoPropostaList[%{#stat.index}].valorComissao" id="comissionadoPropostaValorComissao%{#stat.index}" cssStyle="display: none;"/>
