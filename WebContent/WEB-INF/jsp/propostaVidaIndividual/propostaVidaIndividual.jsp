...
<script language="javascript" charset="UTF-8" src="<s:url value="/js/propostaVidaIndividual/script-pack.js?v=6" includeParams="none"/>"></script>
<script language="javascript" charset="UTF-8" src="<s:url value="/common/hotkeys-pack.js?v=1" includeParams="none"/>"></script>
<script language="javascript" charset="UTF-8" src="<s:url value="/js/propostaVidaIndividual/tab-panel-pack.js?v=0" includeParams="none"/>"></script>
						...
						<tr>
						  ...
						  <td>
							<table onclick="raisePanel(1)" id="tabMenu1" border="0" cellpadding="0" cellspacing="0" class="inactive">
							  <tr>
								<td class="TabLeft"></td>
								<td class="TabBody TabPanel_width">Beneficiários</td>
								<td class="TabRight"/>
							  </tr>
							</table>
						  </td>
...
<form id="formBeneficiario">
  <s:textfield theme="simple" id="associadoId" name="associadoId" cssStyle="display:none;"/>
	...
	<s:textfield theme="simple" id="comSeguradoId" name="beneficiarioIndividual.seguradoIndividual.id" cssStyle="display:none"/>
	<s:textfield theme="simple" id="comBeneficiarioId" name="beneficiarioIndividual.id" cssStyle="display:none"/>
	<s:textfield theme="simple" id="comNome" name="beneficiarioIndividual.nome" cssStyle="display:none"/>
	<s:textfield theme="simple" id="comDataNascimento" name="beneficiarioIndividual.dataNascimento" cssStyle="display:none"/>
	<s:textfield theme="simple" id="comSexo" name="beneficiarioIndividual.sexo" cssStyle="display:none"/>
	<s:textfield theme="simple" id="comParentesco" name="beneficiarioIndividual.parentesco" cssStyle="display:none"/>
	<s:textfield theme="simple" id="comPercentual" name="beneficiarioIndividual.percentual" cssStyle="display:none"/>
</form>
...
<form id="formLookup" name="formLookup">
  <s:textfield theme="simple" id="associadoId" name="associadoId" cssStyle="display:none;"/>
	...
	<input type="hidden" id="idRelatorio" name="idRelatorio" value="PESSOAS_INDIVIDUAL"/>
	  ...
	  <div align="center" style="border: solid 1px #505050; padding: 10px;" >
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td width="50%" >
			  <s:textfield theme="simple" cssStyle="width: 100%" cssClass="clTextoRestritoModal" id="paramCobDescricaoCobertura" name="segIndividualCoberturas.descricao" />
			</td>
		  </tr>
		  <tr>
			<td width="50%" class="TitleCell" style="text-align: left">
			...
			<td width="50%" >
			  <s:select theme="simple" cssClass="requiredField" id="paramCobInformaFranquia" name="segIndividualCoberturas.blnInformaFranquia" list="#{'true':'SIM', 'false':'NAO'}"/>
			</td>
		  </tr>
		  <tr>
