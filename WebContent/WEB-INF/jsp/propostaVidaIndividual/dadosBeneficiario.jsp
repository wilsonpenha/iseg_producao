		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
			  ...
			  <td width="15%">
				...
				<s:textfield theme="simple" cssClass="requiredField clData" id="beneficiarioDataNasc" name="beneficiarioIndividual.dataNascimento" onblur="isValidDate(this)" size="10" maxlength="10"/>
			  </td>
			  <td width="15%">
