		  ...
		  <table class="Main_ContentPane_NavBar" id="tdtopNavButtons">
			<tr class="Main_NavBar_bg">
			  ...
			  <td class="Main_NavBar_RightButton_cell">
				<a class="Main_NavBar_RightButton" href="#" onclick="about();return false;" style="border:0px;" onmouseover="window.status='About';return true;" onmouseout="window.status='';return true;"><img src="<s:url value="/common/web/images/blank.gif" />" class="Main_NavBar_RightButton_Icon Main_NavBar_RightButton_Icon_about" border="0" alt="About" title="About"></img></a>
			  </td>
			  <td class="Main_NavBar_separator_cell"></td>
			  <td class="Main_NavBar_RightButton_cell">
				<a class="Main_NavBar_RightButton" href="#" onclick="" style="border:0px;" onmouseover="window.status='Help';return true;" onmouseout="window.status='';return true;"><img src="<s:url value="/common/web/images/blank.gif" />" class="Main_NavBar_RightButton_Icon Main_NavBar_RightButton_Icon_help" border="0" alt="Help" title="Help"></img></a>
			  </td>
			  <td class="Main_NavBar_separator_cell"></td>
			  <td class="Main_NavBar_bg_logo_left"></td>
			  <td class="Main_NavBar_bg_logo" width="1" onclick="window.open('http://www.atlasinfo.com.br','','width=800,height=600,resizable=yes');return false;"><img src="<s:url value="/common/images/atlasinfo.gif" />" alt="AtlasInfo" title="AtlasInfo" border="0" id="openbravoLogo"></img></td>
...
<div id="allForms" style="overflow:hidden; width:100%;" class="tabPane" >
  <div class="tabPane" id="tabPane0" style="height:auto; width:100%; visibility: hidden;">
    ...
    <tr>
	  <td>
	  <fieldset>
		  <legend><b>Lançamentos, Baixas e Estorno de Comiss&otilde;es</b></legend>
				...
				<div id="divListaComissoes">
				  <table id="tableComissionadoItens" class="listItens">
					...
					<tr style="height: 20px;">
					  ...
					  <td align="center">
					    <s:if test="proposta.ramo.id==5">
					        <fmt:formatDate value="${referenciaParcela}" pattern="MM/yyyy"/>&nbsp;
					    </s:if>
					    <s:else>
						  	<s:property value="nroDaParcela"/>&nbsp;
					    </s:else>
					  	<s:property value="nroDaParcela"/>&nbsp;
					  </td>
					  ...
					  <td align="right">
    					 ...
    					 <s:elseif test="%{natureza == 1}">BAIXA-COMISSAO</s:elseif>
    					 <s:elseif test="%{natureza == 2}">ESTORNO-COMISSAO</s:elseif>
    					 <s:elseif test="%{natureza == 3}">REC-COMISSAO</s:elseif>
    					 <s:elseif test="%{natureza == 4}">CAN-ESTORNO</s:elseif>
    					 <s:elseif test="%{natureza == 5}">AGENCIAMENTO</s:elseif>
    					 <s:elseif test="%{natureza == 6}">CAN-AGENCIAMENTO</s:elseif>
    					 <s:elseif test="%{natureza == 7}">BAIXA-AGENCIAMENTO</s:elseif>
    					 <s:elseif test="%{natureza == 8}">CAN-ESTORNO-AGEN</s:elseif>
					     &nbsp;</td>
		  ...
		  <table width="100%" cellspacing="0" cellpadding="0" class="Main_Client_TableEdition">
			<tr>
			  <td width="34%">
				...
				<s:select theme="simple" id="grupoDeVendaId" name="proposta.grupoDeVenda.id" cssClass="dojoValidateValid" list="grupoDeVendaList" listKey="id" listValue="nomeDoGrupo" onchange="alert('Está alteração não afeta outras propostas nem o cadastro do segurado!\n');alterarGrupoDeVenda();"/>
			  </td>
			  <td width="33%">
					...
					<tr style="height: 20px;">
					  ...
					  <s:elseif test="agenciado.id != null">
						  <td>
						  	<c:set var="totalRepasseComissao" value="${valorPago+totalRepasseComissao}" />
							<s:textfield theme="simple" name="comissionadoPropostaList[%{#stat.index}].id" id="comissionadoPropostaId%{#stat.index}" cssStyle="display: none;"/>
							<s:textfield theme="simple" name="comissionadoPropostaList[%{#stat.index}].agenciado.pessoa.id" id="comissionadoPropostaPessoaId%{#stat.index}" cssStyle="display: none;"/>
							<s:textfield theme="simple" name="comissionadoPropostaList[%{#stat.index}].agenciado.pessoa.nome" id="comissionadoPropostaPessoaNome%{#stat.index}" cssStyle="display: none;"/>
							<s:textfield theme="simple" name="comissionadoPropostaList[%{#stat.index}].agenciado.proposta.id" id="comissionadoPropostaPropostaId%{#stat.index}" cssStyle="display: none;"/>
							<s:textfield theme="simple" name="comissionadoPropostaList[%{#stat.index}].agenciado.comissao" id="comissionadoPropostaComissao%{#stat.index}" cssStyle="display: none;"/>
							<s:textfield theme="simple" name="comissionadoPropostaList[%{#stat.index}].agenciado.tipoComissao" id="comissionadoPropostaTipoComissao%{#stat.index}" cssStyle="display: none;"/>
...
<form id="formCondutor" name="formCondutor">
  <s:textfield theme="simple" id="associadoId" name="associadoId" cssStyle="display:none;"/>
	...
	<input type="hidden" id="fcCondutorProfissao" name="condutor.profissao"/>
