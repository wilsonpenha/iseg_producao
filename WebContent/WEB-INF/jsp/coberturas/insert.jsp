	...
	<td>
	  <table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
		...
		<tr>
		  ...
		  <td width="18%" class="TitleCell"><label class="LabelText">Cobertura Iseg:</label></td>
		  <td width="32%" class="TextBox_ContentCell">
			<s:select theme="simple" cssStyle="width: 100%" tabindex="0" name="coberturasIseg.id" list="coberturasIsegList" listKey="id" listValue="descricao" headerKey="" headerValue="-- Selecione --"/>
		  </td>
		</tr>
	  </table>
	</td>
