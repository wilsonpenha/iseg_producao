				  ...
				  <table id="tableDadosCliente" width="100%" border="0" cellpadding="2" cellspacing="0">
					<tr>
					  <td >
						...
						<s:textfield theme="simple" cssClass="requiredField" id="clienteCnpj" name="pessoaJuridica.cpfOuCnpj" size="23" maxlength="21" onchange="cnpjClienteAlterado=true;setAlterado(true);" onblur="checarCnpjCliente(this);" />
					  </td>
					  <td colspan="2">
					  ...
					  <td >
						<label for="inscricaoEstadual">Inscri��o Estadual</label><br />
