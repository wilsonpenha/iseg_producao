  ...
  <table id="tableCobertura" width="100%" cellspacing="3" cellpadding="3" class="Main_Client_TableEdition" style="padding:4px;">
	...
	<tr>
	  ...
	  <td width="20%">
		...
		<s:textfield theme="simple" id="riscoCoberturaLMI" cssClass="dojoValidateValid requiredField clValor2 currency" cssStyle="width:96%" maxlength="18" name="riscoCobertura.lmi"/>
	  </td>
	  <td width="20%">
		<label for="coberturaPremio">Prêmio</label><br />
		<s:textfield theme="simple" id="riscoCoberturaPremio" cssClass="dojoValidateValid requiredField clValor2 currency" cssStyle="width:96%" maxlength="18" name="riscoCobertura.premio"/>
	  </td>
	  <td width="20%">
		<label for="coberturaFranquia">Franquia</label><br />
		<s:textfield theme="simple" id="riscoCoberturaFranquia" cssClass="dojoValidateValid requiredField clValor2 currency" cssStyle="width:96%" maxlength="18" name="riscoCobertura.franquia"/>
	  </td>
	  <td width="3%">
