		  ...
		  <td>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
			    ...
			    <td valign="bottom"><div  style="width: 107px;">
						...
						<s:if test="referenciaParcela >= proposta.referenciaParcela">
							<tr>
								...
								<td align="right" style="padding-right: 2px;">
									<s:textfield id="baseCalculoComissao%{#stat.index}" name="proposta.parcelasPropostaCollection[%{#stat.index}].valorParcela" theme="simple" cssClass="clValor2 currency" size="10" readonly="true"/>
								</td>
								<td align="right" style="padding-right: 2px;">
								...
								<td align="right" style="padding-right: 2px;">
								  <s:textfield id="valorComissao%{#stat.index}" tabindex="10%{#stat.index+12}" name="proposta.parcelasPropostaCollection[%{#stat.index}].valorComissao" theme="simple"  size="8" readonly="true" cssClass="clValor2 currency" onchange="setAlterado(true);"/>
								</td>
