...
<script language="javascript" charset="UTF-8" src="<s:url value="/js/propostaImoveisFatura/script-pack.js?v=0" includeParams="none"/>"></script>
<script language="javascript" charset="UTF-8" src="<s:url value="/common/hotkeys-pack.js?v=1" includeParams="none"/>"></script>
<script language="javascript" charset="UTF-8" src="<s:url value="/js/propostaTransportes/tab-panel.js?v=0" includeParams="none"/>"></script>
...
<body onload="init();">
<form id="formEdit" namespace="/propostaImoveis" name="formEdit" method="post" onSubmit="if (isNaN(window.event.keyCode)){return false;};">
...
<table style="height:100%" width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
						...
						<tr>
						  ...
						  <td>
							<table onclick="raisePanel(1)" id="tabMenu1" border="0" cellpadding="0" cellspacing="0" class="inactive">
							  <tr>
								<td class="TabLeft"></td>
								<td class="TabBody TabPanel_width">Imóvel</td>
								<td class="TabRight"/>
							  </tr>
							</table>
						  </td>
	...
	<div id="allForms" style="overflow:hidden; width:100%;" class="tabPane" >
	  <div class="tabPane" id="tabPane0" style="overflow-x:hidden; overflow-y:auto; width:100%; visibility: hidden;">
	     <jsp:include page="tabPane0_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane1" style="overflow-x:hidden; overflow-y:auto; visibility: hidden; width:100%">
	     <jsp:include page="tabPane1_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane2" style="overflow-x:hidden; overflow-y:auto; visibility: hidden; width:100%">
	     <jsp:include page="tabPane2_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane3" style="overflow-x:hidden; overflow-y:auto; visibility: hidden; width:100%">
	     <jsp:include page="../proposta/tabApolice_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane4" style="overflow-x:hidden; overflow-y:auto; visibility:hidden; width:100%">
	     <jsp:include page="tabPane4_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane5" style="overflow-x:hidden; overflow-y:auto; visibility:hidden; width:100%">
	     <jsp:include page="tabPane5_noJs.jsp" flush="false"></jsp:include>
	  </div>   
	  <div class="tabPane" id="tabPane6" style="overflow-x:hidden; overflow-y:auto; visibility: hidden;">
...
<form id="formLookup" name="formLookup">
  <s:textfield theme="simple" id="associadoId" name="associadoId" cssStyle="display:none;"/>
	...
	<input type="hidden" id="idRelatorio" name="idRelatorio" value="IMOVEL"/>
	<input type="hidden" id="gpPropostaId" name="proposta.id" />
	<input type="hidden" id="gpIsFatura" name="proposta.isFatura" />
	  ...
	  <div align="center" style="border: solid 1px #505050; padding: 10px;" >
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td width="50%" >
			  <s:textfield theme="simple" cssStyle="width: 100%" cssClass="clTextoRestritoModal" id="paramCobDescricaoCobertura" name="imovelCobertura.descricao" />
			</td>
		  </tr>
		  <tr>
			<td width="50%" class="TitleCell" style="text-align: left">
			...
			<td width="50%" >
			  <s:select theme="simple" cssClass="requiredField" id="paramCobInformaFranquia" name="imovelCobertura.blnInformaFranquia" list="#{'true':'SIM', 'false':'NAO'}"/>
			</td>
		  </tr>
		  <tr>
...
$(document).ready(function(){
	...
	$("#cepRes").autocomplete('<s:url value="/objlookup/getCepList.action" includeParams="none" />', {idFieldsToUpdate:["#bairroRes", "#cidadeRes","#ufRes","#lograRes"],mustMatch:0,minChars:6,width:300,autoFill:false,width:400,max:300,scroll:true,scrollHeight:150,formatItemOnSelect:splitResultGetFirst});
	$("#cepCom").autocomplete('<s:url value="/objlookup/getCepList.action" includeParams="none" />', {idFieldsToUpdate:["#bairroCom", "#cidadeCom","#ufCom","#lograCom"],mustMatch:0,minChars:6,width:300,autoFill:false,width:400,max:300,scroll:true,scrollHeight:150,formatItemOnSelect:splitResultGetFirst});
	$("#cepRis").autocomplete('<s:url value="/objlookup/getCepList.action" includeParams="none" />', {idFieldsToUpdate:["#bairroRis", "#cidadeRis","#ufRis","#lograRis"],onItemSelect:function(){setImovelAlterado(true);},mustMatch:0,minChars:6,width:300,autoFill:false,max:300,scroll:true,scrollHeight:150,formatItemOnSelect:splitResultGetFirst});
