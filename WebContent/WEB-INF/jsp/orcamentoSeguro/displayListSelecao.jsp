...
<script language="javascript" charset="UTF-8" src="<s:url value="/common/common-pack.js?v=1" includeParams="none"/>"></script>  
...
<form id="formLista" name="formLista" method="post">
  ...
  <table width="100%" cellspacing="0" cellpadding="0" align="center" class="Main_Client_TableEdition">
	  ...
	  <td colspan="4">
		<table width="100%" class="FieldGroup" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td class="FieldGroupTitle_MaxSize">Selecionar Proposta</td>
	...
	<tr>
	  <td><s:textfield value="%{blnOrcamento}"/></td>	
	  <s:if test="%{blnOrcamento == false}">
	  ...
	  <td width="32%" class="TextBox_ContentCell">
		<s:select theme="simple" cssClass="dojoValidateValid" id="ramoId" name="propostaSearch.ramo.id" list="ramoList" listKey="id" listValue="nome" headerKey="" headerValue="- SELECIONE -" disabled="true"/>
	  </td>
	</tr>

<s:textfield id="blnRenovacao" name="blnRenovacao" cssStyle="display:none;" theme="simple" />
<s:textfield id="ramoId" name="ramo.id" cssStyle="display:none;" theme="simple" />
