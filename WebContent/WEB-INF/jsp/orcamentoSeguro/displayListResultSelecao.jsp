	...
	<s:iterator value="propostas" status="rowstatus">
		<s:if test="#rowstatus.odd == true">
			<s:if test="ramo.id == ramoAutomovel">
 			  <tr class="tablerow0" title="<s:url value="/proposta/getProposta?proposta.id=" includeParams="none"/><s:property value="id"/>" style="{cursor:pointer;}" id="linha<s:property value="numero"/>" >
			</s:if>
			<s:else> 
		...
		<s:else> 
			<s:if test="ramo.id == ramoAutomovel">
			  <tr class="tablerow1" title="<s:url value="/proposta/getProposta?proposta.id=" includeParams="none"/><s:property value="id"/>" style="{cursor:pointer;}" id="linha<s:property value="numero"/>" >
		    </s:if>
 		    <s:else> 
			...
			<td id="<s:property value="id"/>" onClick="javascript:$('#propostaId').val('<s:property value="id"/>'); editRecord();"><s:property value="terminoVigencia"/></td>
			<td id="<s:property value="id"/>" onClick="javascript:$('#propostaId').val('<s:property value="id"/>'); editRecord();"><s:property value="cliente.nomeCurto"/></td>
			<td id="<s:property value="id"/>" onClick="javascript:$('#propostaId').val('<s:property value="id"/>'); editRecord();"><s:property value="cliente.cpfOuCnpj"/></td>
			<td id="<s:property value="id"/>" onClick="javascript:$('#propostaId').val('<s:property value="id"/>'); editRecord();"><s:property value="ramo.nome"/></td>
