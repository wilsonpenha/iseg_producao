	  ...
	  <td>
		<table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
		  <tr>
			...
			<tr>
				<td width="20%" class="TitleCell" align="left"><span class="LabelText">Tipo de Relatório:</span></td>
			  	<td width="30%" class="TextBox_ContentCell">
			  	    <s:textfield theme="simple" id="idRelatorio" name="idRelatorio" cssStyle="display:none"/>
				    <s:select theme="simple" cssClass="Combo requiredField" id="tipoDeRelatorio" name="tipoDeRelatorio" list="tiposDeRelatorios" listValue="nome"/>
			  	</td>
			</tr>
		  <tr>
		  ...
		  <tr>
			...
			<td width="20%" class="TitleCell" align="left"><span class="LabelText">Coluna</span></td>
		  	<td width="30%" class="TextBox_ContentCell">
		  	    <s:textfield theme="simple" id="idRelatorio" name="idRelatorio" cssStyle="display:none"/>
			    <s:select theme="simple" cssClass="Combo requiredField" id="ordem" name="ordem" list="#{'premio_liquido':'PREMIOS', 'valor_comissao':'COMISSOES', 'previsao_repasse':'PREVISAO DE REPASSE', 'qtde_docs':'QTDE DE DOCS'}"/>
		  	</td>
		  </tr>
...
function openWinReport(){
	...
	submitForm($('#formLista').get(0), '<s:url includeParams="none" method="execute"/>', false, "report");
}
...
function comparaDatas(data1, data2){
	...
	anoMesInicial = data1.substr(6,4) + data1.substr(3,2);
	anoMesFinal = data2.substr(6,4) + data2.substr(3,2);
	
	if (eval(anoMesFinal - anoMesInicial) >= 100){
