...
<div id="paramProposta" style="display:none" >
  ...
  <tr>
    ...
    <td width="50%">
      <s:select theme="simple" cssStyle="width: 100%" tabindex="0" id="paramTipo" name="tipo" list="{'NOVA','RENOVAÇÃO'}" onchange="showHideOpcoesNovaProposta();" onkeyup="showHideOpcoesNovaProposta();" />
    </td>
  </tr>
  </table>
