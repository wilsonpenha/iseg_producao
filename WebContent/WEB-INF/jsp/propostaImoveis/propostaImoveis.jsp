...
<script language="javascript" charset="UTF-8" src="<s:url value="/js/propostaImoveis/script-pack.js?v=6" includeParams="none"/>"></script>
<script language="javascript" charset="UTF-8" src="<s:url value="/common/hotkeys-pack.js?v=1" includeParams="none"/>"></script>
<script language="javascript" charset="UTF-8" src="<s:url value="/js/propostaImoveis/tab-panel-pack.js?v=0" includeParams="none"/>"></script>
...
<table style="height:100%" width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<div id="allForms" style="overflow:hidden; width:100%;" class="tabPane" >
	  <div class="tabPane" id="tabPane0" style="overflow-x:hidden; overflow-y:auto; visibility: hidden;">
	     <jsp:include page="tabPane0_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane1" style="overflow-x:hidden; overflow-y:auto; visibility: hidden;">
	     <jsp:include page="tabPane1_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane2" style="overflow-x:hidden; overflow-y:auto; visibility: hidden">
	     <jsp:include page="tabPane2_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane3" style="overflow-x:hidden; overflow-y:auto; visibility: hidden">
	     <jsp:include page="../proposta/tabApolice_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane4" style="overflow-x:hidden; overflow-y:auto; visibility:hidden;">
	     <jsp:include page="tabPane4_noJs.jsp" flush="false"></jsp:include>
	  </div>
	  <div class="tabPane" id="tabPane5" style="overflow-x:hidden; overflow-y:auto; visibility: hidden;">
...
<form id="formLookup" name="formLookup">
  <s:textfield theme="simple" id="associadoId" name="associadoId" cssStyle="display:none;"/>
	...
	<input type="hidden" id="gpNroFatura" name="proposta.nroFatura" />
