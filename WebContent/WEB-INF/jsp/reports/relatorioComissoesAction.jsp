	...
	<tr>
	  <td>
		<table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
		  ...
		  <tr>
			<td width="20%" class="TitleCell" align="left"><span class="LabelText">Natureza</span></td>
		  	<td width="30%" class="TextBox_ContentCell">
			    <s:select theme="simple" cssClass="Combo requiredField" id="natureza" name="natureza" list="#{'-1':'TODOS', '0':'COMISSAO', '1':'BONUS', '2':'ISS', '3':'IR', '4':'ESTORNO', '5':'AGENCIAMENTO', '6':'ESTORNO-AGENC', '7':'VISTORIA IMPRODUTIVA', '8':'CUSTO DE APOLICE'}"/>
		  	</td>
			<td width="20%" class="TitleCell" align="left"><span class="LabelText">Situação</span></td>
		  	<td width="30%" class="TextBox_ContentCell">
			    <s:select theme="simple" cssClass="Combo requiredField" id="situacao" name="situacao" list="#{'2':'BAIXADOS','0':'PENDENTE','-1':'TODOS'}"/>
		  	</td>
		  </tr>
		  <tr>
...
function openWinReport(){
	...
	submitForm($('#formLista').get(0), getContextApp()+'/jasperreportComissoes/runjasper.action', false, "report");
}

function validaDatas(){
	var retorno = true;
	
	if (($('#inicioDataPagamento').val() == '') && ($('#inicioInicioVigencia').val() == '')) {
		alert('É obrigatório informar uma período inicial!');
		return;
	}
	
	if (($('#fimDataPagamento').val() == '') && ($('#fimInicioVigencia').val() == '')) {
