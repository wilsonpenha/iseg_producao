	...
	<tr>
	  <td>
		<table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableRelation">
		  ...
		  <tr>
			<td class="TitleCell" align="left"><span class="LabelText">Numeração de Apólice</span></td>
		  	<td class="TextBox_ContentCell">
			    <s:select cssClass="Combo requiredField" id="stNroApolice" name="stNroApolice" list="#{'1':'NÃO INFORMADA', '0':'INFORMADA', '-1':'TODAS'}"/>
		  	</td>
			<td class="TitleCell" align="left"><span class="LabelText">Baixa de Apólice</span></td>
		  	<td class="TextBox_ContentCell">
			    <s:select cssClass="Combo requiredField" id="stBaixaApolice" name="stBaixaApolice" list="#{'1':'NÃO BAIXADAS', '0':'BAIXADAS', '-1':'TODAS'}"/>
		  	</td>
		  </tr>
		  <tr>
			<td width="25%" class="TitleCell"><span class="LabelText">Lancto da Apólice: </span></td>
			<td width="25%" class="TextBox_ContentCell" nowrap="nowrap">
				<span class="LabelText" style="font-weight:bold;">a partir de&nbsp;</span>
			  	<s:textfield cssClass="dojoValidateValid clData TextBox_OneCells_width" id="inicioPeriodoDeLanctoApolice" disabled="false" name="periodoDeLanctoApolice.inicio" onblur="isValidDate(this)" size="10"/>
			  	<span class="LabelText" style="font-weight:bold;">&nbsp;até&nbsp;</span>
			  	<s:textfield cssClass="dojoValidateValid clData TextBox_OneCells_width" id="fimPeriodoDeLanctoApolice" disabled="false" name="periodoDeLanctoApolice.fim" onblur="isValidDate(this)" size="10"/>
			</td>
			<td width="25%" class="TitleCell"><span class="LabelText">Data da Baixa: </span></td>
			<td width="25%" class="TextBox_ContentCell" nowrap="nowrap">
				<span class="LabelText" style="font-weight:bold;">a partir de&nbsp;</span>
			  	<s:textfield cssClass="dojoValidateValid clData TextBox_OneCells_width" id="inicioPeriodoDeBaixaApolice" disabled="false" name="periodoDeBaixaApolice.inicio" onblur="isValidDate(this)" size="10"/>
			  	<span class="LabelText" style="font-weight:bold;">&nbsp;até&nbsp;</span>
			  	<s:textfield cssClass="dojoValidateValid clData TextBox_OneCells_width" id="fimPeriodoDeBaixaApolice" disabled="false" name="periodoDeBaixaApolice.fim" onblur="isValidDate(this)" size="10"/>
			</td>
		  </tr>
		  <tr>
			<td width="25%" class="TitleCell"><span class="LabelText">Inicio da Vigência: </span></td>
			<td width="25%" class="TextBox_ContentCell" nowrap="nowrap">
				<span class="LabelText" style="font-weight:bold;">a partir de&nbsp;</span>
			  	<s:textfield cssClass="dojoValidateValid clData TextBox_OneCells_width" id="inicioInicioVigencia" disabled="false" name="periodoDoInicioDaVigencia.inicio" onblur="isValidDate(this)" size="10"/>
			  	<span class="LabelText" style="font-weight:bold;">&nbsp;até&nbsp;</span>
			  	<s:textfield cssClass="dojoValidateValid clData TextBox_OneCells_width" id="fimInicioVigencia" disabled="false" name="periodoDoInicioDaVigencia.fim" onblur="isValidDate(this)" size="10"/>
			</td>
			<td width="25%" class="TitleCell"><span class="LabelText">Ramo </span></td>
			<td width="25%" class="TextBox_ContentCell">
		  ...
		  <tr>
			...
			<td class="TitleCell"><span class="LabelText">Produtor </span></td>
			<td class="TextBox_ContentCell">
		  ...
		  <tr>
			<td class="TitleCell"><span class="LabelText">Grupo de Venda </span></td>
			<td class="TextBox_ContentCell">
		  ...
		  <tr>
			<td class="TitleCell"><span class="LabelText">Situação </span></td>
			<td class="TextBox_ContentCell">
			  <s:select cssClass="Combo Combo_TwoCells_width" id="situacaoOperacionalId" name="situacaoOperacional" list="situacaoOperacionalList" headerKey="" headerValue="-- TODOS --" />
			</td>
			<td class="TitleCell" align="left"><span class="LabelText">Ordenação</span></td>
		  	<td class="TextBox_ContentCell">
		  	    <s:textfield id="idRelatorio" name="idRelatorio" cssStyle="display:none"/>
			    <s:select cssClass="Combo requiredField" id="ordem" name="ordem" list="#{'termino_vigencia':'TERMINO VIGENCIA', 'cliente_nome':'CLIENTE', 'proposta_numero':'NRO PROPOSTA', 'data_transmissao':'DATA TRANSMISSAO'}"/>
		  	</td>
		  </tr>
		  <tr>
			<td class="TitleCell" align="left"><span class="LabelText">Quebra</span></td>
		  	<td class="TextBox_ContentCell">
		  	    <s:textfield id="idRelatorio" name="idRelatorio" cssStyle="display:none"/>
			    <s:select cssClass="Combo requiredField" id="quebra" name="quebra" list="opcoesDeQuebraDoRelatorio" listValue="nome" headerKey="" headerValue="Sem quebra"/>
		  	</td>
		  	<td class="TitleCell" align="left"><span class="LabelText">Usuario</span></td>
		  	<td class="TextBox_ContentCell">
			    <s:select theme="simple" cssClass="" headerKey="-1" headerValue="-- TODOS --" list="usuarioList" listKey="id" listValue="nomeLogin" name="usuarioId"/>
		  	</td>
		  </tr>
...
function openWinReport(){
	...
	submitForm($('#formLista').get(0), getContextApp()+'/jasperreportApoliceParaBaixa/runjasper.action', false, "report");
}

function validaDatas(){
	var retorno = true;
	
	if (($('#inicioPeriodoDeLanctoApolice').val() == '')) {
		alert('É obrigatório informar uma período inicial!');
		return;
	}
	
	if (($('#fimPeriodoDeLanctoApolice').val() == '')) {
