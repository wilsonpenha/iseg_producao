	...
	<table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableRelation">
		<tr>
 		...
 		<tr>
			...
			<tr>
				<td class="TitleCell"><span class="LabelText">Data do Pedido: </span></td>
			...
			<tr>
				<td width="20%" class="TitleCell"><span class="LabelText">Marca: </span></td>
				<td width="10%" class="TextBox_ContentCell">
					<s:textfield id="fabricanteId" name="fabricante.id" cssStyle="display:none;"/>
					<s:textfield id="fabricanteNome" cssClass="TextBox_TwoCells_width" name="fabricante.nome" />
				</td>
				<td width="20%" class="TitleCell"><span class="LabelText">Modelo: </span></td>
				<td width="30%" class="TextBox_ContentCell">
					<s:textfield id="modeloId" name="modelo.id" cssStyle="display:none;"/>
					<s:textfield id="modeloNome" cssClass="TextBox_TwoCells_width" name="modelo.descricao" />
			   	</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="TextBox_ContentCell">
					<s:textfield id="idRelatorio" name="idRelatorio" cssStyle="display:none"/>
					<s:select cssClass="Combo requiredField" id="quebra" name="quebra" list="#{'':'Sem Quebra', 'POR_PRODUTOR':'Por produtor', 'POR_SEGURADORA':'Por seguradora', 'POR_GRUPO_DE_VENDA':'Por grupo de venda'}"/>
				</td>
			</tr>
...
$(document).ready(function(){
	...
	$("#fabricanteNome").autocomplete('<s:url value="/objlookup/getMarcaList.action" includeParams="none" />', {idFieldsToUpdate:["#fabricanteId"],autoFill:false,width:400,max:300,scroll:true,scrollHeight:150,onItemSelect:limpaModeloVeiculo,onClear:limpaModeloVeiculo});
	$("#modeloNome").autocomplete('<s:url value="/objlookup/getModeloVeiculoList.action" includeParams="none" />', {idFieldsToUpdate:["#modeloId"],extraParams:{'fabricante.id':function(){return $("#fabricanteId").val();}},autoFill:false,width:400,max:300,scroll:true,scrollHeight:150});
	
});
function openWinReport(){
	openWin('', 'report', '800', '600', 'resizable=yes');
	submitForm($('#formLista').get(0), getContextApp()+'/jasperreportMarcaModelo/runjasper.action', false, "report");
}
