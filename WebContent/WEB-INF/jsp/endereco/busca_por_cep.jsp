...
<script Language="JavaScript"> 
 ...
 {   
   DocRemote = window.open ('http://www.buscacep.correios.com.br/servicos/dnec/ajuda/ajudaCep.jsp','CEP','scrollbars,resizable,width=320,height=200');  	   
 }    
</script>
	</head>
	<body>			
										...
										<td bgcolor="#002a78">									
											<table width="100%" border="0" cellspacing="1" cellpadding="5">								
												<tr>
													<td bgcolor="#d8e6ed">
													  <table width="100%" border="0" cellspacing="1" cellpadding="5">
  														<form name="Geral" method="post" onSubmit="return CriticaCampos();" action="http://www.buscacep.correios.com.br/servicos/dnec/consultaLogradouroAction.do" target="_blank">
															...
															<input type="hidden" name="Metodo" value="listaLogradouro">
                           									<input type="hidden" name="TipoConsulta" value="cep">
