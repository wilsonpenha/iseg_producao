...
<s:textfield id="enderecoPessoaId" name="endereco.pessoa.id" cssStyle="display:none" />
	  ...
	  <table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
		...
		<tr>
		  ...
		  <td width="38%" class="TextBox_ContentCell">
			<s:textfield theme="simple" id="enderecoId" name="endereco.id" cssStyle="display:none;" /> <s:textfield theme="simple" cssClass="dojoValidateValid requiredField" id="enderecoCep" name="endereco.cep.valor" maxlength="9" />
		  </td>
