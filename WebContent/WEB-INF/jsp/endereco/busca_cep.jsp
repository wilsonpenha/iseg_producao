												...
												<tr>
													<td bgcolor="#d8e6ed">
													  <table border="0" cellspacing="1" cellpadding="5">
  														<form name="Geral" method="post" onSubmit="return CriticaCampos();" action="http://www.buscacep.correios.com.br/servicos/dnec/consultaLogradouroAction.do">
  														  <s:textfield theme="simple" id="associadoId" name="associadoId" cssStyle="display:none;"/>
																...
																<tr>
																	<td colspan="2">
																	<a href="http://www.correios.com.br/servicos/cep/dne.cfm" target="_self"><img src="http://www.correios.com.br/images/cep/dne_azul_p.gif" alt="DNE"  align="right" border="0"></a>
