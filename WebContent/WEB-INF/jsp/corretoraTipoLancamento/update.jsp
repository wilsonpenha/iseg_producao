		...
		<table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
		  ...
		  <tr>
			...
			<td width="32%" class="TextBox_ContentCell">
			  ...
			  <s:textfield theme="simple" id="corretoraTipoLancamentoId" name="corretoraTipoLancamento.tipoLancamento.id" cssStyle="display:none" />
			  <s:select theme="simple" cssClass="dojoValidateValid TextBox_100percent_width" disabled="true" id="corretoraTipoLancamentoId" name="corretoraTipoLancamento.tipoLancamento.id" list="tipoLancamentoTodosList" listKey="id" listValue="nome"  />
			</td>
