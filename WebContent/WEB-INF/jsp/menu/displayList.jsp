...
<form id="formLista" namespace="/menu" name="formLista" method="post">
  <s:textfield theme="simple" id="associadoId" name="associadoId" cssStyle="display:none;"/>

  <s:submit id="submitButton" cssStyle="display:none" theme="simple"/>
  <input id="menuId" type="hidden" name="menu.id" />
	  ...
	  <td colspan="4" class="Button_RightAlign_ContentCell">
		<div align="center">
		  <table>
			<tr>
			  <td>
				<input type="button" id="btnf3" onclick="submitForm(document.formLista, '<s:url action="novo.action" includeParams="none" />', false);" style="display: none;"/>
				<table onmouseout="this.className='wButton'; window.status=''; return true;" onmouseover="this.className='wButton_hover'; 	window.status='Entrar'; return true;" onmouseup="this.className='wButton'; return true;" onmousedown="this.className='wButton_active'; return true;" class="wButton"
					   onclick="document.getElementById('btnf3').click()">
				  <tr>
					<td class="wButton_left"></td>
					<td class="wButton_text wButton_width">F2-Criar Item Pai</td>
       ...
       <td colspan="4">
		...
		<ul id="nav">
			<s:iterator value="menuPaiList" status="level0">
			  	<li id="nav<s:property value="#level0.index+1"/>" onClick="javascript:$('#menuId').val('<s:property value="id"/>');document.formLista.action='editar.action';document.formLista.submit();">
					<img src="<s:url value='/common/web/images/blank.gif'/>" class="Menu_Client_Button_BigIcon_folder" id="<s:property value="id"/>">
					&nbsp;<s:property value="nome.valor"/></span></img>
			  		...
			  		<s:if test="menuCollection.size>0">
						...
						<s:iterator value="menuCollection" status="level1">
							<li id="nav<s:property value="#level0.index+1"/>Sub<s:property value="#level1.index+1"/>" onclick="javascript:$('#menuId').val('<s:property value="id"/>');document.formLista.action='editar.action';document.formLista.submit();">

						  		<s:if test="menuCollection.size>0">
									<img src="<s:url value='/common/web/images/blank.gif'/>" class="Menu_Client_Button_BigIcon_folder" id="<s:property value="id"/>" >
									&nbsp;<s:property value="nome.valor"/></img>
									...
									<s:iterator value="menuCollection" status="level2">
										<li id="nav<s:property value="#level0.index+1"/>Sub<s:property value="#level1.index+1"/>Sub<s:property value="#level2.index+1"/>" onclick="javascript:$('#menuId').val('<s:property value="id"/>');document.formLista.action='editar.action';document.formLista.submit();" >
									  		...
									  		<s:if test="menuCollection.size>0">
												...
												<s:iterator value="menuCollection" status="level3">
													<li id="nav<s:property value="#level0.index+1"/>Sub<s:property value="#level1.index+1"/>Sub<s:property value="#level2.index+1"/>Sub<s:property value="#level3.index+1"/>" onclick="javascript:$('#menuId').val('<s:property value="id"/>');document.formLista.action='editar.action';document.formLista.submit();">
