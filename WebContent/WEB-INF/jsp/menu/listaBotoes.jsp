...
%>
	...
	<table id="tablePerguntas" width="100%" class="listItens">
		  <tr class="listItensHeader">
			...
			<td width="65%">Pergunta</td>
			<td width="15%">Tipo de Resposta</td>
		  </tr>
		  <s:iterator value="perguntasPerfils" status="stat">
			<tr>
			  <td nowrap="nowrap" class="small_image">
				<img alt="" style="cursor:pointer;" src="<s:url value="/common/web/images/delete.gif" includeParams="none"/>" onclick="if(confirma('Confirma exclusão?')){removeCondutor('<s:property value="id"/>');}"/>
				<img alt="" style="cursor:pointer;" src="<s:url value="/common/web/images/edit.gif" includeParams="none"/>" onclick="if(confirma('Confirma edição?')){editarCondutor('<s:property value="id"/>');}"/>
			  </td>
			  <td nowrap="nowrap">
