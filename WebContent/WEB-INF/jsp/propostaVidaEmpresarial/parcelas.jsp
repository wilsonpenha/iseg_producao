				  ...
				  <table id="tableParcelas" class="listItens"> 
						...
						<s:if test="referenciaParcela >= proposta.referenciaParcela">
							<tr>
								...
								<td align="right" style="padding-right: 2px;">
								  <s:textfield id="baseCalculoComissao%{#stat.index}" readonly="true" tabindex="10%{#stat.index+12}" name="proposta.parcelasPropostaCollection[%{#stat.index}].valorComissao" theme="simple"  size="10" maxlength="10" cssClass="clValor2 currency"/>
								</td>
