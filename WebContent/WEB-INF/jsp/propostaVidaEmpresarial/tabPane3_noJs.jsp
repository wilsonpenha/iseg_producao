...
%>
	  ...
	  <table>
	    <tr>
		  <td colspan="4">
		    <div id="divMessagesTab5" class="divMessages" style="padding-bottom: 10px;">
		  	  <s:actionerror/>
			  <s:actionmessage/>
			  <s:fielderror/>
		    </div>
	  ...
	  <div id="divForm6" style="width:100%">
		<fieldset>
		...
		<fieldset>
		<legend accesskey="A"><b><u>A</u>pólice</b></legend>
		<table id="dadosApolice" width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			<td width="25%">
			  <label for="nroApoliceProvisoria">Nro da Apólice provisoria</label><br />
			  <s:textfield theme="simple" id="nroApoliceProvisoria" name="proposta.nroApoliceProvisoria" value="%{proposta.propostaOriginal.nroApoliceProvisoria}" size="20" maxlength="20" onchange="setAlterado(true);"/>
			</td>
			<td>
			  <label for="dataApoliceProvisoria">Dt da Apólice provisoria</label><br />
			  <s:textfield theme="simple" id="dataApoliceProvisoria" cssClass="clData" name="proposta.dataApoliceProvisoria" value="%{proposta.propostaOriginal.dataApoliceProvisoria}" onblur="isValidDate(this)" size="10" maxlength="10" onchange="setAlterado(true);"/>
			</td>
			<td width="25%">
			</td>
			<td width="25%"></td>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			<td colspan="4">
			  ...
			  <s:textarea theme="simple" cssClass="dojoValidateValid requiredField clTextoRestrito TextArea_FourCells_width TextArea_Medium_height" rows="3" id="obsEndosso" name="proposta.obsEndosso" cssStyle="width:97%;" onkeyup="return checkMaxLength(this, 1000);" onchange="setAlterado(true);" />
			</td>
		  </tr>
		</table>
		</fieldset>
		...
		<table border="0" cellpadding="0" cellspacing="0">
		  <tr>
			...
			<s:elseif test="(proposta.statusOperacional == 4 || proposta.statusOperacional == 6 || proposta.statusOperacional == 9) && proposta.situacaoOperacional == 0">
			<td height="23" valign="top">
			  <div>
