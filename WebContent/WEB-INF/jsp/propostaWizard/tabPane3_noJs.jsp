...
%>
	...
	<div id="divForm4" style="width:100%; overflow: auto;">
	  <table>
	    <tr>
		  <td colspan="4">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			  <tr>
				<td width="20%" class="TextBox_ContentCell">
				  ...
				  <s:textfield theme="simple" cssClass="TextBox_OneCells_width requiredField clCalculator clValor2 currency" id="premioLiquido" name="proposta.premioLiquido" onblur="if (this.value=='0,00'){$('#premioTotal').removeClass('readonly')}else{$('#premioTotal').addClass('readonly')}" onchange="javascript:calculaIOF($('#calcularIOF').get(0).checked);calculaPremioTotal();setAlterado(true);" />
				</td>
				<td width="20%" class="TextBox_ContentCell">
				...
				<td width="20%" class="TextBox_ContentCell">
				  ...
				  <s:textfield theme="simple" cssClass="TextBox_OneCells_width clValor2 currency" id="premioTotal" name="proposta.premioTotal" onblur="calcularPremioLiquido();" onchange="setAlterado(true);" />
				</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td>
				  ...
				  <s:textfield theme="simple" id="valor1aParcela" name="proposta.valor1aParcela" cssClass="TextBox_OneCells_width clCalculator clValor2 currency" maxlength="12" onchange="calculaDemaisParcelas();setAlterado(true);"/>
				</td>
				<td>
