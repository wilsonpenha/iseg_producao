				  ...
				  <table id="tableDadosCliente" width="100%" border="0" cellpadding="2" cellspacing="0"> 
					...
					<tr>
					  ...
					  <td>
					    ...
					    <s:textfield theme="simple" id="profissaoId" name="pessoaFisica.profissao.id" cssStyle="display:none;" />
				...
				<td>
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					  ...
					  <td>
						<label id="labelCover" for="cidadeCom">Correspondência<br />
					    <s:radio theme="simple" id="correspondenciaRes" name="proposta.propostaEnderecoCollection[0].correspondencia" list='{"SIM","NAO"}' onchange="radioUnico('correspondenciaRes',this.value)"/>
					    </label>
					  </td>
					  <td>
				...
				<td>
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					  ...
					  <td>
						<label id="labelCover" for="cidadeCom">Correspondência<br />
					    <s:radio theme="simple" id="correspondenciaCom" name="proposta.propostaEnderecoCollection[1].correspondencia" list='{"SIM","NAO"}' onchange="radioUnico('correspondenciaCom',this.value)"/>
					    </label>
					  </td>
					  <td>
...
$().ready(function() {
	...
	if(isEmpty('#propostaId') || $('#statusOperacional').val()==0){
