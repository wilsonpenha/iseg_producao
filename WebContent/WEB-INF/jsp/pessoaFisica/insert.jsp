	...
	<td>
	  <table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
		...
		<tr>
		  ...
		  <td width="32%" class="TextBox_ContentCell">
			<s:textfield theme="simple" cssClass="dojoValidateValid TextBox_100percent_width" id="formEdit_pessoaFisica.profissao" name="pessoaFisica.profissao" maxlength="30"/>
		  </td>				
		</tr>		
		<tr>
		...
		<tr>
		  ...
		  <td width="32%" class="Combo_ContentCell">
		    <s:select theme="simple" cssClass="Combo Combo_OneCells_width   requiredField" id="smsIsAtivo" name="pessoaFisica.smsIsAtivo" list="#{'true':'SIM','false':'NÃO'}" />
		  </td>
		</tr>
		<tr>
		  <td colspan="4">
...
<tr>
		  <td width="22%" class="TitleCell"><label class="LabelText" for=enderecoCep>CEP: </label></td>
		  <td width="28%" class="TextBox_ContentCell">
		  	<s:textfield theme="simple" id="enderecoId" name="pessoaFisica.enderecoCollection[0].id" cssStyle="display:none;" />
		  ...
		  <td class="TextBox_ContentCell">
			<s:textfield theme="simple" cssClass="dojoValidateValid TextBox_100percent_width" id="enderecoLogradouro" name="pessoaFisica.enderecoCollection[0].logradouro" maxlength="60"/>
		  </td>
		</tr>
		<tr>
		  <td width="18%" class="TitleCell"><label class="LabelText" for="enderecoNumero">Número: </label></td>
		  <td width="32%" class="TextBox_ContentCell">
			<s:textfield theme="simple" cssClass="dojoValidateValid requiredField TextBox_100percent_width" id="enderecoNumero" name="pessoaFisica.enderecoCollection[0].numero" maxlength="6" size="11"/>
		  </td>
		  <td class="TitleCell"><label class="LabelText" for="complementoId">Complemento: </label></td>
		  <td class="TextBox_ContentCell">
			<s:textfield theme="simple" cssClass="dojoValidateValid TextBox_100percent_width" id="complementoId" name="pessoaFisica.enderecoCollection[0].complemento" maxlength="60"/>
		  </td>		  
		</tr>
		<tr>
		  <td class="TitleCell"><label class="LabelText" for="enderecoBairroId">Bairro:</label></td>
		  <td class="Textbox_ContentCell">
  			<s:textfield theme="simple" cssClass="dojoValidateValid requiredField TextBox_100percent_width" id="enderecoBairroId" name="pessoaFisica.enderecoCollection[0].bairro" maxlength="50"/>
		  </td>
		  <td width="18%" class="TitleCell" align="left"><label class="LabelText" for="enderecoCidadeId">Cidade:</label></td>
		  <td class="Textbox_ContentCell">
		  			<s:textfield theme="simple" cssClass="dojoValidateValid requiredField TextBox_100percent_width" id="enderecoCidadeId" name="pessoaFisica.enderecoCollection[0].cidade" maxlength="35"/>		  			
		  </td>
		</tr>
		<tr>
		<td width="18%" class="TitleCell" align="left"><label class="LabelText" for="estadoSigla">UF: </label></td>
		  <td width="32%" class="Textbox_ContentCell">
		  	<s:select theme="simple" cssClass="requiredField" id="estadoSigla" headerKey="" headerValue="-- Selecione --" name="pessoaFisica.enderecoCollection[0].uf" list="ufs" listKey="uf" listValue="nome" onchange="setAlterado(true);"/>
		  </td>
		  <td class="TitleCell" align="left"><label class="LabelText" for="enderecoTipoBairro">Tipo Endereço: </label></td>
		  <td class="TextBox_ContentCell">
			<s:select theme="simple" cssClass="ComboKeyNoUpdatable Combo_OneCell_width requiredField" id="enderecoTipoBairro" name="pessoaFisica.enderecoCollection[0].tipoEndereco" list="#{'C':'COMERCIAL','R':'RESIDENCIAL'}" headerKey="" headerValue="-- Selecione --" />
		  </td>
		</tr>
		<tr>
		  <td width="18%" class="TitleCell" align="left"><span class="LabelText">Telefone: </span></td>
		  <td width="32%" class="Textbox_ContentCell">
		  	<s:textfield theme="simple" cssClass="dojoValidateValid clFone TextBox_100percent_width" id="foneId" name="pessoaFisica.enderecoCollection[0].telefone" maxlength="30"/>
		  </td>
		  <td class="TitleCell"><span class="LabelText">Fax: </span></td>
		  <td class="TextBox_ContentCell">
			<s:textfield theme="simple" cssClass="dojoValidateValid TextBox_100percent_width" id="faxId" name="pessoaFisica.enderecoCollection[0].fax" maxlength="30"/>
		  </td>
		</tr>
		<tr>
	  	  <td class="TitleCell"><span class="LabelText">Correspondência ?: </span></td>
	  	  <td class="TextBox_ContentCell">
		    <s:select theme="simple" cssClass="Combo Combo_OneCells_width requiredField" id="correspondencia" name="pessoaFisica.enderecoCollection[0].correspondencia" list="#{'SIM':'SIM','NAO':'NÃO'}" />
	  	  </td>
		</tr>
	  </table>
	</td>
...
$(document).ready(function(){
	...
	//	$("#enderecoCep").autocomplete('<s:url value ="/objlookup/getEnderecoCepAC.action" includeParams="none"/>',{name:"endereco.cep.valor", minChars:3,idFieldsToUpdate:["#enderecoNumero","#complementoId","#enderecoLogradouro","#enderecoTipoBairro","#estadoSigla","#enderecoCidadeId","#enderecoBairroId"]});
	//$("#enderecoCep").autocomplete('<s:url value ="/objlookup/getEnderecoCepAC.action" includeParams="none"/>',{name:"endereco.cep.valor", minChars:3, idFieldsToUpdate:["#enderecoId","#enderecoNumero","#complementoId","#enderecoLogradouro","#enderecoTipoBairro"]});
