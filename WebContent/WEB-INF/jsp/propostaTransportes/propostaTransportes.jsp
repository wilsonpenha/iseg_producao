...
<script language="javascript" charset="UTF-8" src="<s:url value="/js/propostaTransportes/script-pack.js?v=0" includeParams="none"/>"></script>
<script language="javascript" charset="UTF-8" src="<s:url value="/common/hotkeys-pack.js?v=1" includeParams="none"/>"></script>
<script language="javascript" charset="UTF-8" src="<s:url value="/js/propostaTransportes/tab-panel-pack.js?v=0" includeParams="none"/>"></script>
...
<body onload="init();">
<form id="formEdit" namespace="/propostaTransportes" name="formEdit" method="post" onSubmit="if (isNaN(window.event.keyCode)){return false;};">
						...
						<tr>
						  ...
						  <td>
							<table onclick="raisePanel(1)" id="tabMenu1" border="0" cellpadding="0" cellspacing="0" class="inactive">
							  <tr>
								<td class="TabLeft"></td>
								<td class="TabBody TabPanel_width">Risco</td>
								<td class="TabRight"/>
							  </tr>
							</table>
						  </td>
...
<form id="formLookup" name="formLookup">
  <s:textfield theme="simple" id="associadoId" name="associadoId" cssStyle="display:none;"/>
	...
	<input type="hidden" id="gpValorTransportado" name="proposta.valorTransportado" />
	<input type="hidden" id="gpTaxaFaturaAtual" name="proposta.taxaFaturaAtual" />
	<input type="hidden" id="gpCustoApolice" name="proposta.custoApolice" />
	  ...
	  <div align="center" style="border: solid 1px #505050; padding: 10px;" >
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td width="50%" >
			  <s:textfield theme="simple" cssStyle="width: 100%" cssClass="clTextoRestritoModal" id="paramCobDescricaoCobertura" name="transporteCobertura.descricao" />
			</td>
		  </tr>
		  <tr>
...
$().ready(function() {
	// Mascara de telefone. 
    $(".clCep").setMask({mask : '99999999', autoTab: false});
    ...
    $(".clValor2").setMask({mask : '99,999.999.999', type : 'reverse',defaultValue:"+000"});
    $(".clPercentual").setMask({mask : '99,999', type : 'reverse',defaultValue:"+000"});
    $(".clValor1").setMask({mask : '9,999.999.99', type : 'reverse',defaultValue:"00"});
