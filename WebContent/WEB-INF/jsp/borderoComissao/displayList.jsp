...
<script language="javascript" charset="UTF-8" src="<s:url value="/js/borderoComissao/script.js?v=0" includeParams="none"/>"></script>
...
<form id="formLista" name="formLista" method="post">
  ...
  <input id="comissaoId" type="hidden" name="borderoComissao.id" />
  ...
  <table width="100%" cellspacing="0" cellpadding="0" align="center" class="Main_Client_TableEdition">
	  ...
	  <td colspan="4">
		<table width="100%" class="FieldGroup" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td class="FieldGroupTitle_MaxSize">Gerenciamento de Lotes de Pagamento de Comissão</td>
	...
	<tr>
	  ...
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" cssClass="dojoValidateValid" id="numeroProposta" name="borderoComissaoSearch.borderoLancamentoCollection[0].proposta.numero" />
	  </td>
	...
	<tr>
	  ...
	  <td width="18%" class="TitleCell"><label class="LabelText" for="dataExtrato">Data do Extrato</label></td>
	  <td width="32%" class="TextBox_ContentCell" >
		<s:textfield theme="simple" cssClass="dojoValidateValid" id="dataExtrato" name="borderoComissaoSearch.dataDocumento" onblur="isValidDate(this)" size="10" />
	  </td>
	</tr>
	<tr>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="nomeSegurado">Nome do Segurado</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" cssClass="TwoCells_width" id="nomeSegurado" name="borderoComissaoSearch.borderoLancamentoCollection[0].nomeSegurado" size="40" />
	  </td>
      <td width="18%" class="TitleCell"><label class="LabelText" for="paramSeguradoraId">Seguradora</label></td>
      <td width="32%" class="TextBox_ContentCell">
		<s:select theme="simple" cssClass="Combo Combo_TwoCells_width" id="paramSeguradoraId" name="borderoComissaoSearch.seguradora.id" list="seguradoraList" listKey="id" listValue="nome" headerKey="" headerValue="- Selecione -" />
      </td>
	</tr>
	<tr>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="ramoId">Ramo</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:select theme="simple" cssClass="dojoValidateValid" id="ramoId" cssStyle="width: 180px" name="borderoComissaoSearch.borderoLancamentoCollection[0].ramo.id" list="ramoSubRamoList" listKey="id" listValue="nomeRamoSubRamo" headerKey="" headerValue="- Selecione -" />
	  </td>
      <td width="18%" class="TitleCell"><label class="LabelText" for="campoOrdenacao">Campo Ordenação</label></td>
      <td width="32%" class="TextBox_ContentCell">
		<s:select theme="simple" cssClass="Combo dojoValidateValid" id="campoOrdenacao" name="campoOrdenacao" list="#{'0':'NroExtrato', '1':'DataExtrato','2':'Seguradora'}" emptyOption="false"/>
      </td>
	</tr>
	<tr>
      <td width="18%" class="TitleCell"><label class="LabelText" for="campoOrdenacao">Situação</label></td>
      <td width="32%" class="TextBox_ContentCell">
	    <s:select theme="simple" cssClass="Combo dojoValidateValid" id="situacao" name="borderoComissaoSearch.situacao" emptyOption="false" list="situacaoLoteList"/>
      </td>
      <td width="18%" class="TitleCell"><label class="LabelText" for="tipoOrdenacao">Tipo Ordenação</label></td>
      <td width="32%" class="TextBox_ContentCell">
		<s:select theme="simple" cssClass="Combo dojoValidateValid" id="tipoOrdenacao" name="tipoOrdenacao" list="#{'DESC':'DESCENDENTE', 'ASC':'ASCENDENTE'}" emptyOption="false"/>
      </td>
	</tr>
	<tr>
			...
			<tr>
			  ...
			  <td>
				...
				<table onmouseout="this.className='wButton'; window.status=''; return true;" onmouseover="this.className='wButton_hover'; 	window.status='Entrar'; return true;" onmouseup="this.className='wButton'; return true;" onmousedown="this.className='wButton_active'; return true;" class="wButton"
				  ...
				  <tr>
					<td class="wButton_left"></td>
					<td class="wButton_text wButton_width">F2-Criar Lote</td>
					<td class="wButton_right"/>
				  </tr>
				</table>
			  </td>
...
jQuery(document).ready(function(){
	...
	MaskInput($('#dataExtrato').get(0), "99/99/9999");
	$("#nomeSegurado").autocomplete('<s:url value="/objlookup/getClienteListByNome.action" includeParams="none" />', {mustMatch:0,autoFill:false,  width:400,formatItemOnSelect:splitResultGetFirst});
