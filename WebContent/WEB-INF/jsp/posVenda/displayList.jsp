  ...
  <table width="100%" cellspacing="0" cellpadding="0" align="center" class="Main_Client_TableEdition">
	...
	<tr>
	  ...
	  <td width="32%" class="TextBox_ContentCell">
		...
		<s:textfield theme="simple" id="clienteId" name="posVendaSearch.proposta.cliente.id" cssStyle="display:none;"/>
		<s:textfield theme="simple" id="clienteNome" cssClass="TextBox_100percent_width" name="posVendaSearch.proposta.cliente.nome" onblur="javascript:clearSeguradoId(this.value)"/>
	  </td>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="clienteCpfCnpj">CPF/CNPJ</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" id="clienteCpfCnpj" cssClass="dojoValidateValid TextBox_100percent_width" name="posVendaSearch.proposta.cliente.cpfOuCnpj" onblur="javascript:clearSeguradoId(this.value)" />
	  </td>
	</tr>
	<tr>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="numeroProposta">Localizador</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" cssClass="dojoValidateValid" id="numeroProposta" name="posVendaSearch.proposta.numero" />
	  </td>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="numeroPlaca">Nro da Placa</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" cssClass="dojoValidateValid" id="numeroPlaca" name="posVendaSearch.proposta.automovelWizCollection[0].nroPlaca" />
	  </td>
	</tr>
	<tr>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="numeroChassi">Nro do Chassi</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" cssClass="dojoValidateValid" id="numeroChassi" name="posVendaSearch.proposta.automovelWizCollection[0].nroChassis" />
	  </td>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="numeroApolice">Nro da Apólice</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" cssClass="dojoValidateValid" id="numeroApolice" name="posVendaSearch.proposta.nroApolice" />
	  </td>
	</tr>
	<tr>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="nroPropostaSeguradora">Nro Proposta Seguradora</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" cssClass="dojoValidateValid" id="nroPropostaSeguradora" name="posVendaSearch.proposta.nroPropostaSeg" />
	  </td>
	  <td class="TitleCell"><label class="LabelText" for="statusOperacionalId">Fase</label></td>
	  <td class="Combo_ContentCell">
	    <s:select theme="simple" cssClass="Combo Combo_TwoCells_width" id="statusOperacionalId" name="posVendaSearch.proposta.statusOperacional" list="statusOperacionalList" headerKey="" headerValue="- SELECIONE -" />
	  </td>
	</tr>
	<tr>
      ...
      <td width="32%" class="Combo_ContentCell">
		<s:select theme="simple" cssClass="Combo Combo_TwoCells_width" id="seguradoraId" name="posVendaSearch.proposta.seguradora.id" list="seguradorasList" listKey="id" listValue="nome" headerKey="" headerValue="- Selecione -" />
      </td>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="ramoId">Ramo</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:select theme="simple" cssClass="Combo Combo_TwoCells_width" id="ramoId" name="posVendaSearch.proposta.ramo.id" list="ramoSubRamoList" listKey="id" listValue="nomeRamoSubRamo" headerKey="" headerValue="- SELECIONE -" />
	  </td>
	</tr>
	<tr>
		<td width="10%" class="TitleCell"><span class="LabelText">Grupo de Venda: </span></td>
		<td width="10%" class="TextBox_ContentCell">
		  <s:select cssClass="Combo Combo_TwoCells_width" id="grupoVendaId" name="posVendaSearch.proposta.grupoDeVenda.id" list="grupoVendaList" listKey="id" listValue="nomeDoGrupo" headerKey="" headerValue="-- Selecione --" />
		</td>
	    <td width="18%" class="TitleCell"><label class="LabelText" for="isAssessarada">Situação do Pos-Venda?: </label></td>
		<td width="32%" class="Combo_ContentCell">
		  <s:select theme="simple" cssClass="Combo Combo_TwoCells_width" id="statusPosVenda" name="statusPosVenda" list="#{'1':'EM ABERTO','0':'TODOS','2':'BAIXADO'}" emptyOption="false" />
		</td>
	</tr>
	<tr>
...
function listaLista(){
	if ($('#page').val())
		$('#page').val('0');
	submitFormAjax('#formLista', getContextApp()+'/posVenda/listalista.action', '#divResult');
}

function listaNext(){
	submitFormAjax('#formLista', getContextApp()+'/posVenda/listanext.action', '#divResult');
}

function listaPrevious(){
	submitFormAjax('#formLista', getContextApp()+'/posVenda/listaprevious.action', '#divResult');
}

function listaLast(){
	submitFormAjax('#formLista', getContextApp()+'/posVenda/listalast.action', '#divResult');
}

function listaFirst(){
	submitFormAjax('#formLista', getContextApp()+'/posVenda/listafirst.action', '#divResult');
}
