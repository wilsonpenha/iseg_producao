...
<script language="javascript" charset="UTF-8" src="<s:url value="/common/web/js/utils.js?v=0" includeParams="none"/>"></script>
...
<form id="formLista" name="formLista" method="post">
  ...
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" id="main">
	<tr> 
		  ...
		  <tr>
			<td class="Main_LeftTabsBar_bg_body" id="Main_LeftTabsBar">
			  <table cellpadding="0" cellspacing="0" class="Main_LeftTabsBar">
				...
				<tr>
				  <td>
					<a class="Main_LeftTabsBar_ButtonRight" href="#" onclick="submitForm(document.formLista, '<s:url action='../proposta/displayList.action' includeParams="none"/>', false);">
  ...
  <table width="100%" cellspacing="0" cellpadding="0" align="center" class="Main_Client_TableEdition">
	  ...
	  <td colspan="4">
		<table width="100%" class="FieldGroup" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td class="FieldGroupTitle_MaxSize">Pesquisa de Pedidos de Seguro</td>
	...
	<tr>
	  ...
	  <td width="32%" class="TextBox_ContentCell">
		...
		<s:textfield theme="simple" id="clienteNome" cssClass="TextBox_100percent_width" name="propostaSearch.cliente.nome" onblur="javascript:clearSeguradoId(this.value)"/>
	  </td>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="clienteCpfCnpj">CPF/CNPJ:</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" id="clienteCpfCnpj" cssClass="dojoValidateValid TextBox_100percent_width" name="propostaSearch.cliente.cpfOuCnpj" onblur="javascript:clearSeguradoId(this.value)" />
	  </td>
	</tr>
	<tr>
	  ...
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" cssClass="dojoValidateValid" id="numeroPlaca" name="propostaSearch.automovelWizCollection[0].nroPlaca" />
	  </td>
	</tr>
	<tr>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="numeroChassi">Nro do Chassi:</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:textfield theme="simple" cssClass="dojoValidateValid" id="numeroChassi" name="propostaSearch.automovelWizCollection[0].nroChassis" />
	  </td>
	...
	<tr>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="nroPropostaSeguradora">Nro Prop Seguradora:</label></td>
	  <td width="32%" class="TextBox_ContentCell">
	  ...
	  <td class="Combo_ContentCell">
	    <s:select theme="simple" cssClass="Combo Combo_TwoCells_width" id="statusOperacionalId" name="propostaSearch.statusOperacional" list="statusOperacionalList" headerKey="" headerValue="- SELECIONE -" />
	  </td>
	</tr>
	<tr>
      ...
      <td width="32%" class="Combo_ContentCell">
		<s:select theme="simple" cssClass="Combo Combo_TwoCells_width" id="seguradoraId" name="propostaSearch.seguradora.id" list="seguradorasList" listKey="id" listValue="nome" headerKey="" headerValue="- Selecione -" />
      </td>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="ramoId">Ramo:</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:select theme="simple" cssClass="Combo Combo_TwoCells_width" id="ramoId" name="propostaSearch.ramo.id" list="ramoSubRamoList" listKey="id" listValue="nomeRamoSubRamo" headerKey="" headerValue="- SELECIONE -" />
	  </td>
	</tr>
	<tr>
		<td width="18%" class="TitleCell"><span class="LabelText">Situação: </span></td>
		<td width="32%" class="TextBox_ContentCell">
		  <s:select cssClass="Combo Combo_TwoCells_width" id="situacaoOperacionalId" name="propostaSearch.situacaoOperacional" list="situacaoOperacionalListForSearch" emptyOption="false"/>
		</td>
	</tr>
	<tr>
  ...
  <div id="divResult" style="width:100%; overflow: auto;height: 100%"></div>
...
<form id="formLookup" name="formLookup">
  ...
  <tr>
    <td colspan="2">
      ...
      <s:textfield id="blnEndosso" name="blnEndosso" value="false" cssStyle="display:none;" theme="simple" />
      <s:textfield id="blnIsFatura" name="isFatura" cssStyle="display:none;" theme="simple" />
      <s:textfield id="blnRenovacao" name="blnRenovacao" value="false" cssStyle="display:none;" theme="simple" />
    </td>
  </tr>
  <tr>
    <td width="50%" class="TitleCell" style="text-align: left"><label class="LabelText" for="paramTipo">Tipo</label></td>
    <td width="50%">
      <s:select theme="simple" cssClass="Combo Combo_TwoCells_width" cssStyle="width: 100%" tabindex="0" id="paramTipo" name="tipoProposta" list="tipoPropostaList" onchange="showHideOpcoesNovaProposta();" onkeyup="showHideOpcoesNovaProposta();" />
    </td>
  </tr>
  </table>  
  ...
  <tr>
    ...
    <td width="50%">
    	<s:select theme="simple" cssClass="Combo Combo_TwoCells_width" cssStyle="width: 100%" tabindex="0" id="paramRamoId" name="ramo.subRamo.id" list="ramoList" listKey="id" listValue="nome" headerKey="" headerValue="-- Selecione --" onchange="carregaSubRamosProposta();"/>
    </td>
  </tr>
  <tr> 
  <td colspan="2">
  ...
  <tr>
    ...
    <td width="50%"><div id="divRamos"><s:select theme="simple" disabled="true" cssStyle="width: 100%" tabindex="0" id="paramSubRamoId" name="ramo.id" list="{}" listKey="{}" headerKey="" headerValue="-- Selecione --" onchange="carregaSeguradoras();"/></div></td>
  </tr>
  </table>
  </td>
  </tr>
  </table>
  <div id="faturaSimNao" style="display: none;">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	<td width="50%" class="TitleCell" style="text-align: left"><label class="LabelText" for="isFatura">Apólice c/ faturas?: </label></td>
	<td width="50%">
	  <s:select theme="simple" cssStyle="width: 100%" id="isFatura" name="blnFatura" list="#{'true':'SIM','false':'NÃO'}" headerKey="" headerValue="-- Selecione --" onchange="$('#blnIsFatura').val(this.value)"/>
	</td>
  </tr>
  </table>
  </div>
  ...
  <tr>
    <td colspan="2" class="TitleCell" style="text-align: left">
      <input type="radio" id="pj" name="tipoCliente" value="1" onchange="$('#blnPossuiPerfil').val('false');" />
  ...
  <tr>
  	<td><div align="center">
		<input type="button" disabled="disabled" id="btnf2" style="display: none;" onclick="if ($('#faturaSimNao').is(':visible') && $('#isFatura').val()==''){alert('Selecione SIM ou NAO para Apolice c/ fatura!');$('#isFatura').focus();}else{criarNova();}"/>
  		<table onmouseout="this.className='wButton'; window.status=''; return true;" onmouseover="this.className='wButton_hover'; 	window.status='Entrar'; return true;" onmouseup="this.className='wButton'; return true;" onmousedown="this.className='wButton_active'; return true;" class="wButton"
