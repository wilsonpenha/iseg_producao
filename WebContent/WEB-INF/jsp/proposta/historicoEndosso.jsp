...
%>
	  ...
	  <fieldset>
		...
		<table class="tableTag" id="DivTable" width="100%" align="center" border="0" cellpadding="0" cellspacing="0" >
			...
			<td width="15%" nowrap="nowrap"><b>Tp Endosso</b><img src="<s:url value="/common/images/asc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '6' ,'aa','1');"><img src="<s:url value="/common/images/desc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '6' ,'ad','1');"></td>
			<td width="10%" nowrap="nowrap"><b>Nro Endosso</b><img src="<s:url value="/common/images/asc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '7' ,'aa','1');"><img src="<s:url value="/common/images/desc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '7' ,'ad','1');"></td>
			<td width="5%" nowrap="nowrap"><b>Prop Ante</b><img src="<s:url value="/common/images/asc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '8' ,'aa','1');"><img src="<s:url value="/common/images/desc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '8' ,'ad','1');"></td>
			<td width="15%" nowrap="nowrap"><b>Fase</b><img src="<s:url value="/common/images/asc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '9' ,'aa','1');"><img src="<s:url value="/common/images/desc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '9' ,'ad','1');"></td>
			<td width="15%" nowrap="nowrap"><b>Situação</b><img src="<s:url value="/common/images/asc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '10' ,'aa','1');"><img src="<s:url value="/common/images/desc.gif" includeParams="none"/>" onclick="TableSortWait('DivTable', '10' ,'ad','1');"></td>
			</tr>
			...
			<s:iterator value="historicoList" status="rowstatus">
				...
				<s:else>
					...
					<td id="<s:property value="id"/>" onClick="javascript:$('#hiPropostaId').val('<s:property value="id"/>'); editHistorico();"><s:property value="nroEndosso"/></td>
			...
			<s:else>
			  <tr height="20" bgcolor="#CBE3BB"><td colspan="10" style="text-align:center;font-style:italic;">Nenhum registro</td></tr>
			</s:else>
		</table>
