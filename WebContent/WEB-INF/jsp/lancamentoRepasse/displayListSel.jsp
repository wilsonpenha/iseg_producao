...
<form id="formLista" name="formLista" method="post">
  ...
  <table width="100%" cellspacing="0" cellpadding="0" align="center" class="Main_Client_TableEdition">
	...
	<tr>
      ...
      <td width="32%" class="TextBox_ContentCell">
        <s:select theme="simple" cssStyle="width: 100%" tabindex="0" id="paramSeguradoraId" name="propostaSearch.seguradora.id" list="seguradoraList" listKey="id" listValue="nome" headerKey="" headerValue="-- Selecione --" />
      </td>
	  <td width="18%" class="TitleCell"><label class="LabelText" for="ramoId">Ramo</label></td>
	  <td width="32%" class="TextBox_ContentCell">
		<s:select theme="simple" cssClass="dojoValidateValid" id="ramoId" name="propostaSearch.ramo.id" list="ramoList" listKey="id" listValue="nome" headerKey="" headerValue="- SELECIONE -" />
	  </td>
	</tr>
	<tr>
  ...
  <tr>
    ...
    <td width="50%"><s:select theme="simple" cssStyle="width: 100%" tabindex="0" id="paramRamoId" name="ramo.id" list="ramoList" listKey="id" listValue="nome" headerKey="" headerValue="-- Selecione --" /></td>
  </tr>
  <tr>
