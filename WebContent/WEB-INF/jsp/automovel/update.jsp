			  ...
			  <td colspan="6">
				<table id="tableAcrescimoDesconto" width="100%" cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
				  ...
				  <tr>
					...
					<td class="TitleCell"><img align="top" alt="" style="cursor: pointer;" src="../common/web/images/add.gif" onclick="addAcrescimoDesconto();"/></td>
				  </tr>
				</table>
				<table id="tableAcrescimoDescontoItens" class="listItens">
				  ...
				  <s:iterator value="automovel.acrescimoDescontoCollection" status="stat">
					<tr>
					  <td>
						<input type="hidden" name="automovel.acrescimoDescontoCollection[${stat.index}].id" value="<s:property value="id"/>" />
						<input type="hidden" name="automovel.acrescimoDescontoCollection[${stat.index}].acrescimoDesconto" value="<s:property value="acrescimoDesconto"/>" />
						<input type="hidden" name="automovel.acrescimoDescontoCollection[${stat.index}].percentual" value="<s:property value="percentual"/>" />
						<input type="hidden" name="automovel.acrescimoDescontoCollection[${stat.index}].descricao" value="<s:property value="descricao"/>" />
						<s:set name="varAcrescimoDesconto" value="%{#acrescimoDesconto}"/>
						<s:if test="%{#varAcrescimoDesconto == 'a'}">
							Acréscimo
						</s:if>
						<s:elseif test="%{#varAcrescimoDesconto == 'd'}">
							Desconto
						</s:elseif>
						<s:property value="acrescimoDesconto"/>
					  </td>
					  <td><s:property value="percentual"/></td>
					  <td><s:property value="descricao"/></td>
					  <td class="small_image"><img alt="" style="cursor:pointer;" src="../common/web/images/delete.gif" onclick="removeRow(tableAcrescimoDescontoItens, this.parentNode.parentNode.rowIndex);"/></td>
					</tr>
				  </s:iterator>
				</table>
			  </td>
			  ...
			  <td colspan="6">
				<table id="tableServico" class="listItens">
				  ...
				  <s:iterator value="automovel.automovelServicosCollection" status="stat">
					<tr>
					  <td>
					  	<input type="hidden" name="automovel.automovelServicosCollection[${stat.index}].id" value="<s:property value="id"/>" />
					  	<input type="hidden" name="automovel.automovelServicosCollection[${stat.index}].servicos.id" value="<s:property value="servicos.id"/>" />
					  	<input type="hidden" id="automovelServico${stat.count}" name="automovel.automovelServicosCollection[${stat.index}].servicoContratado" value="<s:property value="servicoContratado"/>" />
					  	<s:if test="automovel.automovelServicosCollection[#stat.index].servicoContratado == 'Sim'">
							<input type="checkbox" name="checkbox" checked="checked" onclick="changeValueHidden('automovelServico${stat.count}', this);"/>
						</s:if>
						<s:else>
					  ...
					  <td class="element"><input type="text" class="dojoValidateValid currency TextBox_100percent_width" id="servicoPremio" name="automovel.automovelServicosCollection[${stat.index}].premio" value="<s:property value="premio"/>" onkeypress="return formatNumber(this, event, 2, 8);" style="text-align: right;"/></td>
					  <td class="element">
					  <input type="text" class="dojoValidateValid currency TextBox_100percent_width" id="servicoFranquia" name="automovel.automovelServicosCollection[${stat.index}].franquia"  value="<s:property value="franquia"/>" onkeypress="return formatNumber(this, event, 2, 8);" style="text-align: right;"/></td>
					</tr>
				  </s:iterator>
				</table>
			  </td>
			  ...
			  <td colspan="6">
				<table id="tableCobertura" class="listItens">
				  ...
				  <s:iterator value="automovel.automovelCoberturaCollection" status="stat">
					<tr>
					  <td>
						<input type="hidden" name="automovel.automovelCoberturaCollection[${stat.index}].id" value="<s:property value="id"/>" />
						<input type="hidden" name="automovel.automovelCoberturaCollection[${stat.index}].proposta.id" value="<s:property value="proposta.id"/>" />
						<input type="hidden" name="automovel.automovelCoberturaCollection[${stat.index}].cobertura.id" value="<s:property value="cobertura.id"/>" />
						<input type="hidden" id="automovelCobertura${stat.count}" name="automovel.automovelCoberturaCollection[${stat.index}].coberturaContratada" value="<s:property value="coberturaContratada"/>" />
						<s:if test="automovel.automovelCoberturaCollection[#stat.index].coberturaContratada == 'Sim'">
							<input type="checkbox" name="checkbox" checked="checked" onclick="changeValueHidden('automovelCobertura${stat.count}', this);"/>
						</s:if>
						<s:else>
					  ...
					  <td class="element"><input type="text" class="dojoValidateValid currency TextBox_100percent_width" id="coberturaLMI" name="automovel.automovelCoberturaCollection[${stat.index}].lmi" value="<s:property value="lmi"/>" onkeypress="return formatNumber(this, event, 2, 8);" style="text-align: right;"/></td>
					  <td class="element"><input type="text" class="dojoValidateValid currency TextBox_100percent_width" id="coberturaPremio" name="automovel.automovelCoberturaCollection[${stat.index}].premio" value="<s:property value="premio"/>" onkeypress="return formatNumber(this, event, 2, 8);" style="text-align: right;"/></td>
					  <td class="element"><input type="text" class="dojoValidateValid currency TextBox_100percent_width" id="coberturaFranquia" name="automovel.automovelCoberturaCollection[${stat.index}].franquia" value="<s:property value="franquia"/>" onkeypress="return formatNumber(this, event, 2, 8);" style="text-align: right;"/></td>
					</tr>
				  </s:iterator>
				</table>
			  </td>
			  ...
			  <td colspan="6">
				<table id="tableAcessorio" width="100%" cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
				  <tr>
					...
					<td class="TitleCell"><img align="top" alt="" style="cursor: pointer;" src="<s:url value="/common/web/images/add.gif" includeParams="none"/>" onclick="addAcessorio();"/></td>
				  </tr>
				</table>
				<table id="tableAcessorioItens" class="listItens">
				  ...
				  <s:iterator value="automovel.automovelAcessoriosCollection" status="stat">
					<tr>
					  <td>
						<input type="hidden" name="automovel.automovelAcessoriosCollection[${stat.index}].id" value="<s:property value="id"/>" />
						<input type="hidden" name="automovel.automovelAcessoriosCollection[${stat.index}].acessorio.id" value="<s:property value="acessorio.id"/>" />
						<s:property value="acessorio.valor"/>
					  </td>
					  <td class="small_image"><img alt="" style="cursor:pointer;" src="<s:url value="/common/web/images/delete.gif" />" onclick="removeRow(tableAcessorioItens, this.parentNode.parentNode.rowIndex);"/></td>
					</tr>
				  </s:iterator>
				</table>
			  </td>
...
$(document).ready(function(){
	...
	opener.document.getElementById("bindBtnItensSegurados").click();
});
