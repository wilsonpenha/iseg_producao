  ...
  <table id="tableCobertura" width="100%" cellspacing="3" cellpadding="3" class="Main_Client_TableEdition" style="padding:4px;">
	...
	<tr>
	  ...
	  <td width="20%">
		...
		<s:textfield theme="simple" id="riscoCoberturaPremio" cssClass="dojoValidateValid requiredField clValor2 currency" cssStyle="width:96%" maxlength="18" name="riscoCobertura.premio" onkeypress="return Mascara('numero1', event, document.getElementById('riscoCoberturaPremio'));" onblur="javascript:valida_numero(this,15,2,'riscoCoberturaPremio');"/>
	  </td>
	  <td width="20%">
		<label for="coberturaLMI">LMI</label><br />
		<s:textfield theme="simple" id="riscoCoberturaLMI" cssClass="dojoValidateValid requiredField clValor2 currency" cssStyle="width:96%" maxlength="18" name="riscoCobertura.lmi" onkeypress="return Mascara('numero1', event, document.getElementById('riscoCoberturaLMI'));" onblur="javascript:valida_numero(this,15,2,'riscoCoberturaLMI');"/>
	  </td>
	  <td width="20%">
		<label for="coberturaFranquia">Franquia</label><br />
		<s:textfield theme="simple" id="riscoCoberturaFranquia" cssClass="dojoValidateValid requiredField clValor2 currency" cssStyle="width:96%" maxlength="18" name="riscoCobertura.franquia" onkeypress="return Mascara('numero1', event, document.getElementById('riscoCoberturaFranquia'));" onblur="javascript:valida_numero(this,15,2,'riscoCoberturaFranquia');"/>
	  </td>
	  <td width="3%">
