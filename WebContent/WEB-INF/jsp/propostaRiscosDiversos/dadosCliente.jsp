	  ...
	  <tr>
		<td>
		  ...
		  <table id="tableDadosCliente" width="100%" border="0" cellpadding="2" cellspacing="0">
			<tr>
			  <td width="15%">
				<label for="clienteCpfCnpj"><a href="#" class="LabelLink" onclick="editarCliente();" tabindex="-1" title="Alterar dados Cadastrais do Segurado.">CPF</a></label><br />
		  ...
		  <table id="tableDadosCliente" width="100%" border="0" cellpadding="2" cellspacing="0">
			...
			<tr>
			  ...
			  <td colspan="2">
				...
				<s:textfield theme="simple" id="pfReferencia" name="pessoaJuridica.referenciaPessoal" cssClass="clTextoRestrito" maxlength="50" size="50" onchange="setAlterado(true);"/>
			  </td>
			  <s:if test="%{proposta.id == null}">
			  </tr>
			  <tr>
