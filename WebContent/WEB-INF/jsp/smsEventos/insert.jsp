	...
	<tr>
	  <td>
		<table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
		  ...
		  <tr>
			<td width="18%" class="TitleCell"><label class="LabelText" for="privilegio">Nome: </label></td>
			<td width="32%" class="TextBox_ContentCell">
			  <s:textfield theme="simple" id="smsEventosId" name="smsEventos.id" cssStyle="display:none;"/>
			  <s:textfield theme="simple" cssClass="dojoValidateValid TextBox_TwoCells_width requiredField" id="smsEventosNome" name="smsEventos.nome" maxlength="30"/>
			</td>
		  ...
		  <tr>
			...
			<td width="32%" class="Combo_ContentCell">
			  <s:select theme="simple" cssClass="ComboKeyNoUpdatable 100percent_width requiredField" id="statusId" name="smsEventos.isAtivo" list="#{'true':'ATIVO','false':'INATIVO'}" emptyOption="false"/>
			</td>
		  </tr>
		</table>
	  </td>
