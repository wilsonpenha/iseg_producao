		...
		<table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
		  ...
		  <tr>
			...
			<td width="32%" class="TextBox_ContentCell">
			  <s:textfield theme="simple" cssClass="TextBox_TwoCells_width" id="clientePJNome" name="importPessoaJuridica.nome" maxlength="60"/></td>	
			<td width="18%" class="TitleCell"><span class="LabelText">Importar CNPJ: </span></td>
			<td width="32%" class="TextBox_ContentCell">
			  <s:textfield theme="simple" cssClass="TextBox_TwoCells_width" id="clienteCnpj" name="importPessoaJuridica.cpfOuCnpj" />
			</td>
			</tr>
			</table>
			</fieldset>
		  ...
		  <tr>
			<td colspan="4">
			  <div id="divDadosProdutor" name="divDadosProdutor">
			  	<jsp:include page="dadosProdutorPJ.jsp"></jsp:include>
			  </div>
			  </td>
			</tr> 
	  </table>
...
$(document).ready(function(){
	...
	$("#clientePJNome").autocomplete('<s:url value="/objlookup/getClientePJListByNome.action" includeParams="none" />', {idFieldsToUpdate:["#pessoaJuridicaId"], onItemSelect:carregaPessoaJuridica, mustMatch:0, autoFill:false,width:400,max:300,scroll:true,scrollHeight:150,formatItemOnSelect:splitResultGetFirst});
	$("#clienteCnpj").autocomplete('<s:url value="/objlookup/getClienteListByCnpj.action" includeParams="none" />', {idFieldsToUpdate:["#pessoaJuridicaId"], onItemSelect:carregaPessoaJuridica, mustMatch:0, autoFill:false,width:400,max:300,scroll:true,scrollHeight:150,formatItemOnSelect:splitResultGetFirst});
