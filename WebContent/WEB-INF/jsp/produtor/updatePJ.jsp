	  ...
	  <td>
		<table cellspacing="3" cellpadding="0" align="center" class="Main_Client_TableEdition">
	      ...
	      <s:textfield theme="simple" id="tipoClienteSN" name="tipoClienteSN" cssStyle="display:none;" />
              ...
              <s:textfield theme="simple" id="id" name="pessoaJuridica.id" cssStyle="display:none"/>
		...
		<tr>
		  ...
		  <tr>
			<td class="TitleCell"><label for="telefoneAlternativo">Telefone Alternativo</label></td>
			<td class="TextBox_ContentCell">
				<s:textfield theme="simple" id="telefoneAlternativo" cssClass="clFone" name="pessoaJuridica.telefoneAlternativo" size="16" maxlength="16"/>
			</td>
			<td class="TitleCell"><span class="LabelText">Telefone Celular: </span></td>
			<td class="TextBox_ContentCell">
			  <s:textfield theme="simple" cssClass="dojoValidateValid clFone TextBox_TwoCells_width" id="telefoneCelularId" name="pessoaJuridica.telefoneCelular" maxlength="16"/>
			</td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<td class="TextBox_ContentCell">
				<s:select theme="simple" cssClass="dojoValidateValid TextBox_100percent_width requiredField" id="grupoDeVendaId" name="pessoaJuridica.grupoDeVenda.id" list="grupoDeVendaList" listKey="id" listValue="nomeDoGrupo" headerKey="" headerValue="-- Selecione --" onchange="alert('Esta alteração não tem efeito sobre proposta existentes!\n');"/>
			</td>
		  </tr>
		</table>
	  </td>
