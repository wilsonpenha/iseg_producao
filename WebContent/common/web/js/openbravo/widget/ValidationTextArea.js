...
dojo.widget.defineWidget(
	// class
	"openbravo.widget.ValidationTextArea",
	...
	// member variables/functions
	{
		...
		rows:"",
		// override css
		templatePath: dojo.uri.dojoUri("../openbravo/widget/templates/ValidationTextArea.html"),
		templateCssPath: null, // Defined in the skin --- ValidationTextArea.css
