...
dojo.widget.defineWidget(
	...
	dojo.widget.DatePicker,
	{
		...
		templatePath: dojo.uri.moduleUri("dojo.widget", "templates/MonthlyCalendar.html"),
		templateCssPath: dojo.uri.moduleUri("dojo.widget", "templates/MonthlyCalendar.css"),
