...
if(tabCount==0){$("#dataProposta").focus();}else if(tabCount==1){$("#seguradoConjuge").focus();}else if(tabCount==2){$("#premioLiquido").focus();}else if(tabCount==3){$("#nroApolice").focus();}else if(tabCount==4){$("#grupoDeVendaId").focus();}}
