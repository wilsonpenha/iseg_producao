...
public class SMSAgente extends HttpServlet implements ServletContextAware {


		private static final long serialVersionUID = 1L;
	    private static Log log = LogFactory.getLog(SMSAgente.class.getName());
		...
		*/
		public SMSAgente(SmsEventosCorretoraService service) {
