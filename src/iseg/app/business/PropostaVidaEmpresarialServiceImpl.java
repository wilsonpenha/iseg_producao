...
public class PropostaVidaEmpresarialServiceImpl extends PropostaServiceImpl implements PropostaVidaEmpresarialService {
	...
	public void copyDadosProposta(Proposta propostaEndossada, Proposta proposta) throws Exception{
		...
		if(propostaEndossada.getSeguradoEmpresarialCollection() != null){
			SeguradoEmpresarial seguradoEmpresarialTmp = null;
			for(SeguradoEmpresarial seguradoEmpresarial : propostaEndossada.getSeguradoEmpresarialCollection()){
				seguradoEmpresarialTmp = (SeguradoEmpresarial)Util.cloneBean(seguradoEmpresarial, "id", "proposta");
				seguradoEmpresarialTmp.setProposta(proposta);
				this.save(seguradoEmpresarialTmp);
				proposta.getSeguradoEmpresarialCollection().add(seguradoEmpresarialTmp);
				...
				if (proposta.getSeguradora().getId().equals(propostaEndossada.getSeguradora().getId())){
					if(seguradoEmpresarial.getSeguradoCoberturasCollection() != null){
						SeguradoCoberturas seguradoCoberturasTmp = null;
						for(SeguradoCoberturas seguradoCoberturas : seguradoEmpresarial.getSeguradoCoberturasCollection()){
							seguradoCoberturasTmp = (SeguradoCoberturas)Util.cloneBean(seguradoCoberturas, "id", "seguradoEmpresarial","sequencia");
							seguradoCoberturasTmp.setSeguradoEmpresarial(seguradoEmpresarialTmp);
							this.save(seguradoCoberturasTmp);
							seguradoEmpresarialTmp.getSeguradoCoberturasCollection().add(seguradoCoberturasTmp);
						}
					}
				}
			}
