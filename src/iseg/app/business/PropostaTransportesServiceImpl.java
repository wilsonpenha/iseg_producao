...
public class PropostaTransportesServiceImpl extends PropostaServiceImpl implements PropostaTransportesService {
	...
	public void copyDadosProposta(Proposta propostaEndossada, Proposta proposta) throws Exception{
		...
		if(propostaEndossada.getRiscoTransportesCollection() != null){
			RiscoTransportes riscoTransportesTmp = null;
			for(RiscoTransportes riscoTransportes : propostaEndossada.getRiscoTransportesCollection()){
				riscoTransportesTmp = (RiscoTransportes)Util.cloneBean(riscoTransportes, "id", "proposta");
				riscoTransportesTmp.setProposta(proposta);
				this.save(riscoTransportesTmp);
				proposta.getRiscoTransportesCollection().add(riscoTransportesTmp);

				if(riscoTransportes.getTransporteCoberturasCollection() != null){
					TransporteCoberturas TransporteCoberturasTmp = null;
					for(TransporteCoberturas TransporteCoberturas : riscoTransportes.getTransporteCoberturasCollection()){
						TransporteCoberturasTmp = (TransporteCoberturas)Util.cloneBean(TransporteCoberturas, "id", "riscoTransportes","sequencia");
						TransporteCoberturasTmp.setRiscoTransportes(riscoTransportesTmp);
						this.save(TransporteCoberturasTmp);
						riscoTransportesTmp.getTransporteCoberturasCollection().add(TransporteCoberturasTmp);
					}
				}
			}
		}
